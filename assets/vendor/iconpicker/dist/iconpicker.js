        ...
        function l(e, n) {
          for (var t = {}, i = [], o = 0; o < e.length; o++) {
            ...
            -1 !== d
              ...
              : r.push({ identifier: u, updater: h(f, n), references: 1 }),
              i.push(u);
          }
          return i;
        }
    ...
    (() => {
      ...
      var a = (function () {
        function e(n, t) {
          ...
          !(function (e, n) {
            ...
            r(this, "setIconOnChange", function () {
              var e;
              if (i.el.value == "") {
                null !== (e = i.options) &&
                  void 0 !== e &&
                  e.showSelectedIn &&
                  (i.options.showSelectedIn.innerHTML = "&nbsp;");
              } else {
                null !== (e = i.options) &&
                  void 0 !== e &&
                  e.showSelectedIn &&
                  (i.options.showSelectedIn.innerHTML = '<i class="'.concat(
                    i.el.value,
                    '"></i>'
                  ));
              }
            ...
            r(this, "focusIn", function () {
              var e, n, t, o;
              null !== (e = i.el.nextElementSibling) &&
                void 0 !== e &&
                null !== (n = e.classList) &&
                void 0 !== n &&
                n.contains("iconpicker-dropdown") &&
                ((i.el.nextElementSibling.querySelector("ul").style.top =
                  i.el.offsetHeight + "px"),
                null !==
                  (t =
                  ...
                  void 0 !== t &&
                  t &&
                  (i.el.nextElementSibling.style.transition =
                    "0.25s ease-in-out"),
                i.el.nextElementSibling.classList.add("show"));
            }),
            r(this, "set", function () {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ? arguments[0]
                  : "";
              return (i.el.value = i.valueFormat(e));
            }),
            (this.el = n),
            (this.options = t);
          var o = t.hideOnSelect,
            ...
            g = void 0 === b ? null : b;
          (this.valueFormat =
            "function" == typeof (null == t ? void 0 : t.valueFormat)
              ? t.valueFormat
              : function (e) {
                  return e;
                }),
              ...
              '\n            <div class="iconpicker-dropdown '
                ...
                .concat(
                  f
                    .map(function (e) {
                      return '<li value="'
                        .concat(i.valueFormat(e), '" class="')
                        .concat(u === e ? c : "", '"><i class="')
                        .concat(i.valueFormat(e), '"></i></li>');
                    })
                    .join(""),
                  "\n                </ul>\n            </div>\n        "
                )
            ...
            this.el.nextElementSibling
              ...
              .forEach(function (e) {
                return e.addEventListener("click", function (n) {
                  ...
                  null ===
                    (t =
                      i.el.nextElementSibling.querySelector("li.selected")) ||
                    void 0 === t ||
                    t.classList.remove(c),
                    e.classList.add(c);
                  var o = e.getAttribute("value");
                  (i.el.value = o),
                    a && i.el.nextElementSibling.classList.remove("show"),
                    g &&
                      (i.options.showSelectedIn.innerHTML = '<i class="'.concat(
                        o,
                        '"></i>'
          ...
          (t = [
            {
              ...
              value: function () {
                for (
                  var e = this.nextElementSibling.getElementsByTagName("li"),
                    n = new RegExp(this.value, "i"),
                    t = 0;
                  t < e.length;
                  t++
                ) {
                  var i = e[t];
                  n.test(i.getAttribute("value"))
      ...
      (window.Iconpicker = a),
        document.addEventListener("click", function (e) {
          document
            .querySelectorAll(".iconpicker-dropdown")
            .forEach(function (n) {
              n.contains(e.target) ||
                n.previousElementSibling.contains(e.target) ||
